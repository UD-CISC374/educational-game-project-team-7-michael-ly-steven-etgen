...
export default class InstructScene2 extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.text(this.bg_width/2-500, 600, 
            'Eat fish smaller than you to gain points! Avoid fish bigger \nthan you. If you attempt to eat them, you will lose points \nand respawn. \n\n*Hint: Fish smaller than you will try to \nswim the other way if you get too close.', 
            {fontFamily: 'Georgia, "Goudy Bookletter 1911", Times, serif', 
            fontSize: '40px' 
        });

        this.nextButton = this.add.sprite(this.bg_width/2, 950, "next").setInteractive();
